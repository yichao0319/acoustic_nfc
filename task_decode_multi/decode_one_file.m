...
function [BER] = decode_one_file(seed, filename, input_rcv_dir, output_rcv_dir, start_offset, threshold)
...
[Hfft, sync_fft] = get_H(wav_packet_orig, preamble_offset, ...
